          ...
          <div class="row no-gutters d-flex align-items-center" data-scrollax=" properties: { translateY: '-30%'}">
            <div class="col-md-3 mb-3">
              <a href="#" class="featured-img">
                ...
                <img :src="assetpath('assets/images/image_1.jpg')" class="img-fluid" alt="">
                <div class="text p-4 d-flex align-items-center">
                  <div class="user d-flex align-items-center">
                    <div class="user-img mr-3" :style="{'background-image': 'url(' + assetpath('assets/images/person_1.jpg') + ')'}"></div>
                  ...
                  <div class="row no-gutters d-flex align-items-end">
                    <div class="col-md-8">
                      <a href="#" class="featured-img">
                        ...
                        <img :src="assetpath('assets/images/image_5.jpg')" class="img-fluid" alt="">
                        <div class="text p-4 d-flex align-items-center">
                          <div class="user d-flex align-items-center">
                            <div class="user-img mr-3" :style="{'background-image': 'url(' + assetpath('assets/images/person_1.jpg') + ')'}"></div>
                            <h3>John Bruce <br><span class="position">Designer</span></h3>
                    ...
                    <div class="col-md-4">
                      <a href="#" class="featured-img">
                        ...
                        <img :src="assetpath('assets/images/image_4.jpg')" class="img-fluid" alt="">
                        <div class="text p-4 d-flex align-items-center">
                          <div class="user d-flex align-items-center">
                            <div class="user-img mr-3" :style="{'background-image': 'url(' + assetpath('assets/images/person_1.jpg') + ')'}" ></div>
                            <h3>John Bruce <br><span class="position">Designer</span></h3>
                  ...
                  <div class="row no-gutters d-flex align-items-start">
                    <div class="col-md-8">
                      <a href="#" class="featured-img">
                        ...
                        <img :src="assetpath('assets/images/image_6.jpg')" class="img-fluid" alt="">
                        <div class="text p-4 d-flex align-items-center">
                          <div class="user d-flex align-items-center">
                            <div class="user-img mr-3" :style="{'background-image': 'url(' + assetpath('assets/images/person_1.jpg') + ')'}"></div>
                            <h3>John Bruce <br><span class="position">Designer</span></h3>
                    ...
                    <div class="col-md-4">
                      <a href="#" class="featured-img">
                        ...
                        <img :src="assetpath('assets/images/image_3.jpg')" class="img-fluid" alt="">
                        <div class="text p-4 d-flex align-items-center">
                          <div class="user d-flex align-items-center">
                            <div class="user-img mr-3" :style="{'background-image': 'url(' + assetpath('assets/images/person_1.jpg') + ')'}"></div>
                            <h3>John Bruce <br><span class="position">Designer</span></h3>
            ...
            <div class="col-md-3">
              <a href="#" class="featured-img">
                ...
                <img :src="assetpath('assets/images/image_2.jpg')" class="img-fluid" alt="">
                <div class="text p-4 d-flex align-items-center">
                  <div class="user d-flex align-items-center">
                    <div class="user-img mr-3" :style="{'background-image': 'url(' + assetpath('assets/images/person_1.jpg') + ')'}"></div>
                    <h3>John Bruce <br><span class="position">Designer</span></h3>
